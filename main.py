...
def tools():
  ...
  #OUTPUT-------OUTPUT---------OUTPUT-------------OUTPUT--------OUTPUT--------OUTPUT--------OUTPUT------OUTPUT
    ...
    opText = Text(opFrame,height=34,width=80,bg='#302f2a',fg='white',font=("Arial 13 bold"))
    ...
    #    list2 = []
        for subdon in list1:
            try:
                ...
                quit()
       # print(list2)
    subdopic = Image.open("coding.png")
    subdopicresize1 = subdopic.resize((75,75))
    subdopicresize3 = ImageTk.PhotoImage(subdopicresize1)
    p1=Button(toolWindow,image = subdopicresize3,text="Team",height=105,width=105,bg="white",border=1,command = subdo).place(x=130,y=110)
    l1=Label(toolWindow,text="Sub-Domain",font=("courier 15 italic bold"),fg="#e0556a",width=13,bg="#ebf0ec").place(x=99,y=230)
    ...
    def dnsLookup():
        ...
        for records in record_types:
            ...
            #print("*"*30)
                ...
                quit()
    dnspic = Image.open("coding.png")
    dnspicresize1 = dnspic.resize((75,75))
    dnspicresize3 = ImageTk.PhotoImage(dnspicresize1)
    p1=Button(toolWindow,image = dnspicresize3,text="Team",height=105,width=105,bg="white",border=1,command = dnsLookup).place(x=370,y=110)
    l1=Label(toolWindow,text="DNS-LookUp",font=("courier 15 italic bold"),fg="#e0556a",width=13,bg="#ebf0ec").place(x=350,y=230)
    
  #OPENPORT--------OPENPORT---------OPENPORT--------OPENPORT---------OPENPORT--------OPENPORT---------OPENPORT--------OPENPORT
    openportpic = Image.open("coding.png")
  ...
  #WhoISLookUP-------WhoISLookUP--------WhoISLookUP-------WhoISLookUP--------WhoISLookUP-------WhoISLookUP--------WhoISLookUP
    ...
    whoispic = Image.open("coding.png")
  ...
  #SAVESUBDOMAIN---------SAVESUBDOMAIN---------SAVESUBDOMAIN---------SAVESUBDOMAIN---------SAVESUBDOMAIN---------SAVESUBDOMAIN
    def subdomainSave():
        ...
        inpsubbtn = Button(toolWindow,text="Submit",width = 9,height=1,command=subdosave,fg="white",bg="blue").place(x=1220,y=30)

    
    add1pic = Image.open("coding.png")
