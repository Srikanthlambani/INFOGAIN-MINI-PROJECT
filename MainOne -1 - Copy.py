...
def tools():
    website = iptext.get()
    name1 = website.split('.')
    if len(name1)< 3 or website == "Enter Website Address":
        messagebox.showwarning("Warning","Enter the correct Website address.\nPlease enter with atleast one sub domain Ex: www.google.com")
        return
  ...
  #OPENPORT--------OPENPORT---------OPENPORT--------OPENPORT---------OPENPORT--------OPENPORT---------OPENPORT--------OPENPORT
    def openPorts():
        toolName['text']='Open Ports'
        toolName['fg']="white"
        opText['highlightbackground'] = 'indigo'
        opText['highlightthickness'] = 2
        if opText != None:
            opText.delete('1.0',END)
        portsList = []
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-------------Hidden Directories----------------@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@################
    ...
    p1=Button(toolWindow,text="Hidden Directories",width=18,bg="#c3c3c2",cursor="hand2 red",border=0,font=("courier 12 italic bold"),fg="blue",command = hidDir).place(x=110,y=680)
    l1=Label(toolWindow,image = hiddirpic,fg="#e0556a",height=105,width=105,bg="#c3c3c2").place(x=130,y=580)
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@------------ADD New Feature----------------@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@################
    ...
    addpic1 = Image.open('add.png')
    addpic2 = addpic1.resize((80,80))
    addpic = ImageTk.PhotoImage(addpic2)
    
 #   p1=Button(toolWindow,text="ADD",width=10,bg="#c3c3c2",cursor="hand2 red",border=0,font=("courier 12 italic bold"),fg="blue",command = addnew).place(x=360,y=680)
    l1=Label(toolWindow,image = addpic,fg="#e0556a",height=105,width=105,bg="#c3c3c2").place(x=370,y=585)
...
def devTeam():
    ...
    Button(devWindow,text="Mrs.Krishna Priya",width=18,bg="yellow",border=0,cursor='hand2',command = None,font=("courier 13 italic bold"),fg="black").place(x=450,y=50)
    labelmam = tk.Button(devWindow,image=mampic,fg="#e0556a",height=130,width=130,bg="black").place(x=200,y=50)
    label0mam = Label(devWindow,text='(Guide)',width=18,bg='yellow',border=0,font=("courier 13 italic bold"),fg="black").place(x=450,y=90)
    
    jaggupic1 = Image.open('jaggu.png')
    jaggupic2 = jaggupic1.resize((150,150))
    jaggupic = ImageTk.PhotoImage(jaggupic2)
    Button(devWindow,text="Monangi Jagadeesh",width=18,bg="yellow",border=0,cursor='hand2',command = None,font=("courier 13 italic bold"),fg="black").place(x=10,y=400)
    labeljaggu = tk.Button(devWindow,image=jaggupic,fg="#e0556a",height=105,width=105,bg="black").place(x=50,y=270)
    label0 = Label(devWindow,text='N170985',width=18,bg='yellow',border=0,font=("courier 13 italic bold"),fg="black").place(x=10,y=440)

    sripic1 = Image.open('sri.png')
    sripic2 = sripic1.resize((150,150))
    sripic = ImageTk.PhotoImage(sripic2)
    Button(devWindow,text="Lambani Srikanth",width=18,bg="yellow",border=0,cursor='hand2',command = None,font=("courier 13 italic bold"),fg="black").place(x=250,y=400)
    labelsri = tk.Button(devWindow,image=sripic,fg="#e0556a",height=105,width=105,bg="black").place(x=290,y=270)
    label3 = Label(devWindow,text='N170874',width=18,bg='yellow',border=0,font=("courier 13 italic bold"),fg="black").place(x=250,y=440)

    ragpic1 = Image.open('rag.png')
    ragpic2 = ragpic1.resize((150,150))
    ragpic = ImageTk.PhotoImage(ragpic2)
    Button(devWindow,text="Billa Raghava",width=18,bg="yellow",border=0,cursor='hand2',command = None,font=("courier 13 italic bold"),fg="black").place(x=470,y=400)
    labelrag = tk.Button(devWindow,image=ragpic,fg="#e0556a",height=105,width=105,bg="black").place(x=510,y=270)
    label2 = Label(devWindow,text='N171080',width=18,bg='yellow',border=0,font=("courier 13 italic bold"),fg="black").place(x=470,y=440)

    lakhpic1 = Image.open('lakh.png')
    lakhpic2 = lakhpic1.resize((150,150))
    lakhpic = ImageTk.PhotoImage(lakhpic2)
    Button(devWindow,text="Karanam Lakshmi",width=18,bg="yellow",border=0,cursor='hand2',command = None,font=("courier 13 italic bold"),fg="black").place(x=690,y=400)
    labellakh = tk.Button(devWindow,image=lakhpic,fg="#e0556a",height=105,width=105,bg="black").place(x=730,y=270)
    label1 = Label(devWindow,text='N170468',width=18,bg='yellow',border=0,font=("courier 13 italic bold"),fg="black").place(x=690,y=440)
    

    likhpic1 = Image.open('likh.png')
    likhpic2 = likhpic1.resize((150,150))
    likhpic = ImageTk.PhotoImage(likhpic2)
    Button(devWindow,text="Bunga Likitha",width=18,bg="yellow",border=0,cursor='hand2',command = None,font=("courier 13 italic bold"),fg="black").place(x=910,y=400)
    labellikh = tk.Button(devWindow,image=likhpic,fg="#e0556a",height=105,width=105,bg="black").place(x=950,y=270)
    label5 = Label(devWindow,text='N170448',width=18,bg='yellow',border=0,font=("courier 13 italic bold"),fg="black").place(x=910,y=440)
